...
// const DropdownPopup
export default (({ preview, className, buttonClasses, contentAlign = 'left', children }) => {
    return (
                    ...
                    >
                        <Popover.Panel
                            className={classNames(
                                'focus:outline-none absolute z-20 mt-2 w-max origin-top-right rounded-lg bg-theme-background shadow-lg ring-1 ring-black ring-opacity-5',
                                `${contentAlign}-0`,
                            )}
                        >
                            {children}
